  ...
  <div class="mb-2 flex flex-col gap-2 pb-2">
    ...
    >
      <div class="flex justify-between">
        ...
        <ul class="flex gap-1 sm:gap-3">
          ...
          <li>
            <SocialButton
              to="https://www.linkedin.com/in/carlos-marques-93a60521b"
              title="LinkedIn"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <SocialButton to="https://youtube.com/@psybitcoin" title="Youtube">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22"
                height="22"
          ...
          <li>
            <SocialButton to="https://github.com/Psycarlo" title="Github">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
    ...
    >
      <p class="text-center text-sm text-brand-grayDark dark:text-brand-gray">
        © 2025 Carlos Marques | Software Engineer & Designer
      </p>
      <div class="text-sm">
        by
        <a
